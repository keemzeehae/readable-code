...
public class MinesweeperGame {
    ...
    //NEARBY_LAND_MINE_COUNTS : 어떤 cell 주변에 있는 지뢰의 갯수
    private static final boolean[][] LAND_MINES = new boolean[BOARD_ROW_SIZE][BOARD_COL_SIZE]; //지뢰들
    ...
    private static void open(int row, int col) {  //재귀: 자기자신을 호출하는 함수 (스택오버플로우 주의)
